...
//获取订单状态
//id:1 '待付款' 2:待发货 3:待收货 4:待评价 5:已完成 6:已取消
  ...
  <scroll-view scroll-y class="viewport" id="scroller" @scrolltolower="onScrolltolower">
    <template v-if="order">
      ...
      <view class="overview" :style="{ paddingTop: safeAreaInsets?.top + 20 + 'px' }">
        <!-- 待付款状态:展示去支付按钮和倒计时 -->
        <template v-if="order?.orderState === orderStateList[1].id">
        ...
        <template v-else>
          ...
          <view class="button-group">
            ...
            <view
              v-if="isDev && order.orderState == orderStateList[2].id"
              class="button"
              @tap="onOrderSend"
            >
              模拟发货
      ...
      <view class="goods">
        <view class="item">
          ...
          <!-- 待评价状态:展示按钮 -->
          <view class="action" v-if="order.orderState == orderStateList[4].id">
